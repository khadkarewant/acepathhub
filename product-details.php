                    ...
                    <?php if (!empty($subjects)): ?>
                        <div class="d-flex flex-column gap-1">
                            <?php foreach ($subjects as $s): ?>
                                <div class="d-flex justify-content-between align-items-center" style="max-width:300px;">
                            ...
                            <?php if (!empty($s['syllabus_path']) && file_exists($s['syllabus_path'])): ?>
                                ...
                                target="_blank" class="btn-qs-sm ms-3" style="font-size:0.75rem;padding:2px 8px;white-space:nowrap;">
                                    Syllabus
                                </a>
                            <?php endif; ?>
                        </div>
